...
train = os.path.dirname(os.getcwd()) + '/data/self_dialogue/train/dialogue_train.txt'
dev = os.path.dirname(os.getcwd()) + '/data/self_dialogue/dev/dialogue_dev.txt'

parser = argparse.ArgumentParser()
parser.add_argument('--train_path', action='store', dest='train_path',
                    help='Path to train data', default=train)
parser.add_argument('--dev_path', action='store', dest='dev_path',
                    help='Path to dev data', default=dev)
...
if opt.load_checkpoint is not None:
    ...
    train = torchtext.data.TabularDataset(path=opt.train_path, format='tsv', fields=[('src', src), ('tgt', tgt)], filter_pred=len_filter)
    dev = torchtext.data.TabularDataset(path=opt.dev_path, format='tsv', fields=[('src', src), ('tgt', tgt)], filter_pred=len_filter)
